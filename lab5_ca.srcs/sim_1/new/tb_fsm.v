...
module tb_fsm();
    ...
    //  Initialize slow_en and generate pulses
    initial begin
    ...
    initial begin
        ...
        //the counter drops to 0 immediately
        $display("Applying reset mid-count...");
        rst = 1; 
        #20 rst = 0; 

        // 4.Restarting countdown 
        // Verifying we can start a new countdown immediately after the reset
        sw_val = 16'd3;
        #20 start_btn = 1;
        #10 start_btn = 0;
